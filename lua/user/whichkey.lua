...
local mappings = {
	...
	["f"] = {
		--[[ For file without preview window ]]
	...
	d = {
		...
		l = { "<cmd>lua require'dap'.continue()<cr>", "dap launch" },
		c = { "<cmd>lua require'dap'.continue()<cr><cmd>WhichKey <LT>leader>d<CR>", "dap continue" },
		si = { "<cmd>lua require'dap'.step_into()<cr><cmd>WhichKey <LT>leader>d<CR>", "step into" },
		so = { "<cmd>lua require'dap'.step_over()<cr><cmd>WhichKey <LT>leader>d<CR>", "step over" },
		sb = { "<cmd>lua require'dap'.step_out()<cr><cmd>WhichKey <LT>leader>d<CR>", "step back" },
		-- r = { "<cmd>lua require'dap'.repl.toggle()<cr>", "foobar" },
		-- r = { "<cmd>lua require'dap'.run_last()<cr>", "foobar" },
		-- tu = { "<cmd>lua require'dapui'.toggle()<cr>", "foobar" },
		tt = { "<cmd>lua require'dap'.terminate()<cr>", "dap terminate" },

                -- use ctrl + cmnds for this
